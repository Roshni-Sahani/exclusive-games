...
const Silvercard = () => {
  return (
    <>
      <div
        className="xl:max-w-[1140px] mx-auto xl:px-3 container px-6 py-12"
        data-aos="zoom-in-right"
      >
        <h2 className="md:text-[48px] font-normal font-anton text-white text-center text-[36px]">
          Nuestras ofertas
        </h2>
        <p className="font-inter font-medium text-[16px] text-white text-center pt-2">
        ...
        <div className="max-w-[1140px] mt-14 bg-gradient2 border-[0.5px] border-solid border-[#839090] border-gradient rounded-[16px] lg:p-[57px_40px_32px_46px] p-[7px_40px_32px_46px]">
          <div className="flex flex-wrap flex-row -mx-3">
            ...
            <div className="lg:w-5/12 w-full px-3">
              ...
              <p className="lg:text-[16px] text-[14px] font-medium text-[#CDD2D3] font-inter pt-3">
                Diseño predeterminado, atractivo y fácil de navegar, tecnología
                HTLM5.
              </p>
              <h2 className="md:text-[48px] text-[30px] font-normal text-white font-anton">
                $5000
              </h2>
              <div className="flex gap-2 pt-4">
                ...
                <p className="text-[16px] font-medium text-[#CDD2D3] font-inter">
