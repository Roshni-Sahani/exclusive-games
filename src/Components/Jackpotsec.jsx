...
import jackpotimg1 from "../assests/images/jackpotimg1.webp";
...
const Jackpotsec = () => {
  return (
    <div className="relative">
      <div className=" lg:pt-[150px] sm:pt-[70px] pt-[50px]">
        <div className="xl:max-w-[1140px] mx-auto xl:px-3 container px-6">
          <div className="flex flex-wrap -mx-3 flex-row">
            <div
              className="lg:w-1/2 w-full ps-3  pe-3 md:pe-[32px] flex justify-center"
              data-aos="flip-left"
            >
              <img
                src={jackpotimg1}
                alt="1"
                className="w-full md:max-w-[558px] sm:max-w-[492px] mb-4"
              />
            </div>
            <div className="lg:w-1/2 w-full px-3" data-aos="flip-right">
              <p className="text-white lg:text-[48px] text-[36px] font-anton leading-[57.6px] font-normal">
                Potenciando sus elecciones
              </p>
              <p className="text-base font-inter font-medium leading-[25.6px] text-[#cdd0d1] pt-4">
                Con Exclusive Game lo mejor está de tu lado.
              </p>
              <div className="flex gap-[8px] pt-6">
                <svg
                  width="24"
                  height="25"
                  viewBox="0 0 24 25"
                ...
                <p className="text-base text-[#cdd0d1] leading-[25.6px] font-inter">
                  Tecnología HTML5
                </p>
              </div>
              ...
              <div className="flex gap-[8px] pt-[12px]">
                ...
                <p className="text-base text-[#cdd0d1] leading-[25.6px] font-inter max-w-[412px]">
              ...
              <div className="flex gap-[8px] pt-[12px]">
                ...
                <p className="text-base text-[#cdd0d1] leading-[25.6px] font-inter max-w-[380px]">
                  Aplicación para android y windows de regalo.
                </p>
              </div>
              <p className="text-base text-[#cdd0d1] leading-[25.6px] font-inter pt-6">
      ...
      <div className="absolute bottom-[-271%] right-0">
        <img src={elli3} alt="ellipse2" />
      </div>
    </div>
  );
};

export default Jackpotsec;
